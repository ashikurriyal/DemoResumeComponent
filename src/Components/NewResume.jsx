    ...
    <div className="max-w-5xl mx-auto bg-white shadow-lg p-10 my-10 rounded-lg">
      ...
      <div className="mt-10">
        ...
        <p className="text-gray-600">
          Experienced Full Stack Developer with a passion for building responsive and scalable web applications. Expertise in JavaScript, React, Node.js, and modern web development technologies. Adept at working in agile environments and leading development teams to deliver top-notch solutions.
        </p>
      </div>
      ...
      <div className="mt-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Tech Innovators Inc. | Jan 2020 - Present</p>
          <ul className="list-disc ml-5 mt-2 text-gray-600">
            <li>Developed and maintained full-stack web applications using React, Node.js, and MongoDB.</li>
            <li>Led a team of 5 developers to build scalable and secure cloud-based solutions.</li>
            <li>Collaborated with UX/UI designers to implement responsive designs and improve user experience.</li>
          </ul>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Creative Solutions | June 2017 - Dec 2019</p>
          <ul className="list-disc ml-5 mt-2 text-gray-600">
            <li>Developed and optimized dynamic websites using React and Vue.js.</li>
            <li>Worked closely with backend teams to integrate REST APIs.</li>
            <li>Ensured cross-browser compatibility and optimized web applications for performance.</li>
          </ul>
        </div>
      </div>
      ...
      <div className="mt-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">University of California, Berkeley | Graduated 2017</p>
        </div>
      </div>
      ...
      <div className="mt-10">
        ...
        {/* Project 1 */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-800">E-commerce Website</h3>
          <p className="text-gray-600">A full-stack e-commerce website built using React, Node.js, and MongoDB. Integrated features like product management, cart functionality, and payment gateway.</p>
        </div>

        {/* Project 2 */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-800">Task Management App</h3>
          <p className="text-gray-600">A task management application for teams to organize tasks and track progress. Built with React and Firebase for real-time updates and user authentication.</p>
        </div>
      </div>
      ...
      <div className="mt-10">
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-800">Certified React Developer</h3>
